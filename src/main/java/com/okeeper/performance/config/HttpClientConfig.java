package com.okeeper.performance.config;
...
public class HttpClientConfig {
    ...
    private Integer maxTotal = 100000;// 最大连接

    private Integer defaultMaxPerRoute = 10000;// 每个host的最大连接

    private Integer connectTimeout = 5000;// 建立连接超时时间

    private Integer connectionRequestTimeout = 5000;// 请求超时时间

    private Integer socketTimeout = 10000;// 请求成功等待响应超时时间
